package com.danny.ws.soap.handlers;
...
public class SiteHandler implements SOAPHandler<SOAPMessageContext> {
    ...
    public boolean handleMessage(SOAPMessageContext context) {
        ...
        if (!isResponse) {
            ...
            try {
                ...
                while (childElements.hasNext()) {
                    ...
                    if (name != null) {
                        System.out.println("Node is ===>>> " + eachNode.getValue());
                    }
        ...
        return true; // it must always return true otherwise it will not call the WS endpoint
    }
