 ...
 * generated in the com.danny.generated package.
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://sumws.danny.com/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://sumws.danny.com/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.danny.generated
     */
     ...
     * @return the new instance of {@link JAXBElement }{@code <}{@link CalculateSum }{@code >}
     */
    @XmlElementDecl(namespace = "http://sumws.danny.com/", name = "calculateSum")
     ...
     *
     * @param value Java instance representing xml element's value.
     * @return the new instance of {@link JAXBElement }{@code <}{@link CalculateSumResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://sumws.danny.com/", name = "calculateSumResponse")
